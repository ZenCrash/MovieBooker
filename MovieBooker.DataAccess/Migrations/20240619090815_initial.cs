        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Runtimes_Cinemas_CinemaId",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Runtimes_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Runtimes_CinemaId",
                table: "Runtimes",
                column: "CinemaId");

            migrationBuilder.CreateIndex(
                name: "IX_Runtimes_MovieId",
                table: "Runtimes",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_Runtimes_RoomId",
                table: "Runtimes",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialOpeningTimes_CinemaId",
                table: "SpecialOpeningTimes",
                column: "CinemaId");
        }
